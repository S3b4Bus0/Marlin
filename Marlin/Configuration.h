...
#define STRING_CONFIG_H_AUTHOR "SeBa" // Who made the changes.
...
#define MACHINE_UUID "320af1d9-92ab-4983-9c6a-3b1fe2c51ef1"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  48.61,  48.61 }
    #define DEFAULT_Ki_LIST {   4.67,   4.67 }
    #define DEFAULT_Kd_LIST { 126.42, 126.42 }
  #else
    #define DEFAULT_Kp  48.61
    #define DEFAULT_Ki   4.67
    #define DEFAULT_Kd 126.42
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 79.78
  #define DEFAULT_bedKi 11.88
  #define DEFAULT_bedKd 357.29
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.5, 81.2, 430, 439 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 300, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37.8, 2.7, -2.65 }
